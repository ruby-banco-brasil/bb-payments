...
module BancoBrasilPayments
  ...
  class RootTypeForBankSlipsBatchPayment
    ...
    attr_accessor :slips_details_list
    ...
    def hash
      [payment_contract, debit_branch_office, debit_current_account, check_digits_debit_current_account, slips_details_list, request_id].hash
    end
