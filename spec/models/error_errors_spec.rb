...
# Unit tests for BancoBrasilPayments::ErrorErrors
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ErrorErrors' do
  before do
    # run before each test
    @instance = BancoBrasilPayments::ErrorErrors.new
  end
  ...
  describe 'test an instance of ErrorErrors' do
    it 'should create an instance of ErrorErrors' do
      expect(@instance).to be_instance_of(BancoBrasilPayments::ErrorErrors)
    end
  end
